...
exports.caraCaregiverAvailabilityReminder = exports.caraMilestoneGreetings = exports.caraAppointmentCompletion = exports.caraReengageDormant = exports.caraWeeklyCheckin = exports.caraInterviewFollowup = exports.caraDailyCheck = void 0;
 ...
 */
exports.caraDailyCheck = functions.pubsub
    ...
    try {
        ...
        for (const doc of appointments.docs) {
            ...
            await sendWhatsAppMessage(appt.userPhone, `Good morning! ☀️ ${appt.caregiverName} arrives at ${appt.schedule.timeSlot} today. ` +
                `Reply CONFIRM to confirm or RESCHEDULE if you need to change.`);
            // Send reminder to caregiver
            if (appt.caregiverPhone) {
                await sendWhatsAppMessage(appt.caregiverPhone, `Reminder: You have a shift with ${appt.clientName} at ${appt.schedule.timeSlot} today. ` +
 ...
 */
exports.caraInterviewFollowup = functions.pubsub
    ...
    try {
        ...
        for (const doc of interviews.docs) {
            ...
            await sendWhatsAppMessage(interview.userPhone, `How did your interview with ${interview.caregiverName} go? 🤔\n\n` +
 ...
 */
exports.caraWeeklyCheckin = functions.pubsub
    ...
    try {
        ...
        for (const doc of activeUsers.docs) {
            const user = doc.data();
            await sendWhatsAppMessage(user.phoneNumber, `Hi ${((_a = user.whatsappName) === null || _a === void 0 ? void 0 : _a.split(' ')[0]) || 'there'}! 👋\n\n` +
 ...
 */
exports.caraReengageDormant = functions.pubsub
 ...
 */
exports.caraAppointmentCompletion = functions.pubsub
    ...
    try {
        ...
        for (const doc of appointments.docs) {
            ...
            if (apptTime && now.getHours() > apptTime + 2) {
                // Request feedback
                await sendWhatsAppMessage(appt.userPhone, `How did today's care go with ${appt.caregiverName}? ⭐\n\n` +
 ...
 */
exports.caraMilestoneGreetings = functions.pubsub
    .schedule('0 10 * * *')
    .timeZone('America/Los_Angeles')
    .onRun(async (context) => {
    ...
    try {
        ...
        for (const doc of birthdayUsers.docs) {
            const user = doc.data();
            await sendWhatsAppMessage(user.phoneNumber, `🎂 Happy Birthday${user.whatsappName ? ' ' + user.whatsappName.split(' ')[0] : ''}!\n\n` +
 ...
 */
exports.caraCaregiverAvailabilityReminder = functions.pubsub
    ...
    try {
        ...
        for (const doc of caregivers.docs) {
            ...
            await sendWhatsAppMessage(caregiver.phone, `Good morning ${caregiver.name}! ☀️\n\n` +
...
//# sourceMappingURL=caraCron.js.map