...
exports.populateTestData = functions.https.onRequest(async (req, res) => {
    ...
    try {
        ...
        for (const caregiver of caregivers) {
            ...
            await docRef.set(Object.assign(Object.assign({}, caregiver), { createdAt: admin.firestore.FieldValue.serverTimestamp() }));
