                ...
                <div className="relative h-48 bg-gradient-to-br from-teal-500 to-blue-600">
                    ...
                    <div className="absolute -bottom-16 left-6">
                        <div className="relative">
                            <img
                                src={caregiver.imageUrl || caregiver.photo || DEFAULT_CAREGIVER_AVATAR}
                                alt={caregiver.name}
                    ...
                    <div className="pt-20 px-6 pb-6">
                                ...
                                <div>
                                    ...
                                    {caregiver.location && (
                                        <div className="flex items-center text-slate-500 text-sm mt-1">
                                            ...
                                            {caregiver.location} {caregiver.distance && `• ${caregiver.distance.toFixed(1)} mi away`}
                                        </div>
                                    )}
                                </div>
                            ...
                            <div className="flex items-center gap-4 flex-wrap">
                                {caregiver.rating && (
                                    <div className="flex items-center gap-1 bg-orange-50 px-3 py-1.5 rounded-lg">
                                        ...
                                        <span className="font-bold text-slate-900">{caregiver.rating.toFixed(1)}</span>
                                        {caregiver.reviewCount && (
                                            <span className="text-xs text-slate-500">({caregiver.reviewCount} reviews)</span>
                                        )}
                                    </div>
                                )}
                        ...
                        {caregiver.availability && caregiver.availability.length > 0 && (
                            <div className="mb-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {caregiver.availability.map((slot, idx) => (
                                        <span
                                            key={idx}
